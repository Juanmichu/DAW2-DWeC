...
for(let key = 0; key < articles.length; key++) {
    ...
    let articleTextDiv1 = articles[key].getElementsByTagName('div')[0];
    ...
    // 6. Reemplazar Servicio Murciano de Salud por S.M.S.
    //document.body.innerHTML = document.body.innerHTML.replace('/Servicio Murciano de Salud/g', 'S.M.S');
